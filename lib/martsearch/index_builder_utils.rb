...
module MartSearch
  ...
  module IndexBuilderUtils
    ...
    def setup_and_move_to_work_directory
      ...
      ['dataset_downloads','document_cache','solr_xml'].each do |cache_dir|
        Dir.mkdir(cache_dir) unless File.directory?(cache_dir)
        if cache_dir == 'dataset_downloads'
          Dir.chdir(cache_dir)
    ...
    #
    # @param [String] cache_dir The type of cache_dir to open [dataset_downloads / document_cache / solr_xml]
